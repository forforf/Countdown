...
@available(iOS 13.0, *)
struct CountdownAPIDependencies: CountdownDependenciesProtocol {
    let referenceTimeProvider = { Date().timeIntervalSince1970 }
    let countdownFrom = 3.0
    let interval = 0.5
    let countdownPublisherClosure = TimerPublisher().countdownPublisher
}

@available(iOS 14.0, *)
class CountdownAPITests: XCTestCase {
...
//    }
    ...
    func test_api() throws {
        let deps = CountdownAPIDependencies()
        let countdown = Countdown(deps)
        XCTAssertEqual(Countdown.initialCountdownTime, 0.0)
        XCTAssertEqual(countdown.time, Countdown.initialCountdownTime)
...
//    }
//
//    func makeDependencies(_ countdownList: [Double]) -> CountdownDependenciesProtocol {
...
//    struct MockCountdownDependencies: CountdownDependenciesProtocol {
//        let referenceTimeProvider: ReferenceTimeProvider
//        let countdownFrom: Double
//        let interval: TimeInterval
//        let countdownPublisherClosure: CountdownPublisherClosure
//    }
//
//    struct MockFactory {
//
...
//        ) -> CountdownDependenciesProtocol {
//
//            return MockCountdownDependencies(
